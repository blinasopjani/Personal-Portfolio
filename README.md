# Blina Sopjani — Personal Portfolio

🌐 **Live Site:** [https://blinasopjani.github.io/Personal-Portfolio/](https://blinasopjani.github.io/Personal-Portfolio/)
...
- Smooth scroll-reveal animations on all elements

## Technologies Used
- **HTML5** – Semantic page structure
- **Vanilla CSS3** – Custom design system with CSS variables, gradients, animations
- **Vanilla JavaScript** – Scroll reveal, project filtering, sticky navbar, grain canvas
